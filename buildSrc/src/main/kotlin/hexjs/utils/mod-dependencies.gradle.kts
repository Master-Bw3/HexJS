...
abstract class HexJsModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexJsModDependenciesExtension>("hexjsModDependencies")
