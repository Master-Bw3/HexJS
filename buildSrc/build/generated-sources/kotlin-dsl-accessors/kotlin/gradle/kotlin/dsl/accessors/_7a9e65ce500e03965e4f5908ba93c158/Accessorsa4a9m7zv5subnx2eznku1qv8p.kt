 ...
 */
internal
val net.fabricmc.loom.configuration.FabricApiExtension.`ext`: org.gradle.api.plugins.ExtraPropertiesExtension get() =
 ...
 */
internal
fun net.fabricmc.loom.configuration.FabricApiExtension.`ext`(configure: Action<org.gradle.api.plugins.ExtraPropertiesExtension>): Unit =
