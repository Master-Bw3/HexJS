...
package gradle.kotlin.dsl.plugins._47f8cc4bac84afb074deb9f91bdfdf59
...
/**
 * The `architectury-plugin` plugin implemented by [dev.architectury.plugin.ArchitecturyPlugin].
 */
internal
val `PluginDependenciesSpec`.`architectury-plugin`: PluginDependencySpec
    get() = this.id("architectury-plugin")
...
internal
class `AtPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `at`.
 */
internal
val `PluginDependenciesSpec`.`at`: `AtPluginGroup`
    get() = `AtPluginGroup`(this)


/**
 * The `at.petra-k` plugin group.
 */
@org.gradle.api.Generated
internal
class `AtPetra-kPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `at.petra-k`.
 */
internal
val `AtPluginGroup`.`petra-k`: `AtPetra-kPluginGroup`
    get() = `AtPetra-kPluginGroup`(plugins)


/**
 * The `at.petra-k.PKPlugin` plugin implemented by [at.petrak.pkpcpbp.PKPlugin].
 */
internal
val `AtPetra-kPluginGroup`.`PKPlugin`: PluginDependencySpec
    get() = plugins.id("at.petra-k.PKPlugin")


/**
 * The `at.petra-k.PKSubprojPlugin` plugin implemented by [at.petrak.pkpcpbp.PKSubprojPlugin].
 */
internal
val `AtPetra-kPluginGroup`.`PKSubprojPlugin`: PluginDependencySpec
    get() = plugins.id("at.petra-k.PKSubprojPlugin")
...
/**
 * The `dev.architectury` plugin group.
 */
@org.gradle.api.Generated
internal
class `DevArchitecturyPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dev.architectury`.
 */
internal
val `DevPluginGroup`.`architectury`: `DevArchitecturyPluginGroup`
    get() = `DevArchitecturyPluginGroup`(plugins)


/**
 * The `dev.architectury.loom` plugin implemented by [net.fabricmc.loom.bootstrap.LoomGradlePluginBootstrap].
 */
internal
val `DevArchitecturyPluginGroup`.`loom`: PluginDependencySpec
    get() = plugins.id("dev.architectury.loom")
...
/**
 * The `me.modmuss50` plugin group.
 */
@org.gradle.api.Generated
internal
class `MeModmuss50PluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `me.modmuss50`.
 */
internal
val `MePluginGroup`.`modmuss50`: `MeModmuss50PluginGroup`
    get() = `MeModmuss50PluginGroup`(plugins)


/**
 * The `me.modmuss50.mod-publish-plugin` plugin implemented by [me.modmuss50.mpp.MppPlugin].
 */
internal
val `MeModmuss50PluginGroup`.`mod-publish-plugin`: PluginDependencySpec
    get() = plugins.id("me.modmuss50.mod-publish-plugin")
